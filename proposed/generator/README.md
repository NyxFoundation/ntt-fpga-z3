...
that instantiates for **any Proth NTT prime** `q = k·2^m + 1`. This is what
lifts the paper from "two tricks for q = 12289" to "a verified method,
demonstrated on Falcon and Kyber".
...
(4q vs 6q first-fold offset) — both valid; the hand-written unit is one
